...
const Home = () => {
    ...
    return (
        <div className={`container mx-auto bg-${isDarkMode ? 'black' : 'white'} text-${isDarkMode ? 'white' : 'black'}`}>
            ...
            <Outlet></Outlet>
            {/* Welcome text */}
            <div className="p-5 my-8 ml-3 text-2xl border-l-8 border-red-600 rounded-full carter-font hover:animate-newsHeadline">
                <div className="news-headline-container animate-newsHeadline">
                    <span className="news-headline-text">
                       <FaHandshake></FaHandshake> Welcome to Language School
                        <br />
                        <span className="flex items-center gap-3 text-base text-gray-400">
                            <FaPeopleArrows />
                            most popular foreign language platform ever the world.
                        </span>
                    </span>
                </div>
            </div>
